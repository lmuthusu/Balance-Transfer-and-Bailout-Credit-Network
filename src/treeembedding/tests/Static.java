...
public class Static {
	...
	public static void main(String[] args) {
		...
		Config.overwrite("MAIN_DATA_FOLDER", "/Users/lalitha/Downloads/data/static/");
		String path = "/Users/lalitha/Downloads/";
		// iteration
		int i = Integer.parseInt("0");
		// configuration in terms of routing algorithm 0-10, see below
		int config = Integer.parseInt("7");
